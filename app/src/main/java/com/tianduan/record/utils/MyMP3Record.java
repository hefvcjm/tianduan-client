package com.tianduan.record.utils;
...
import com.tianduan.record.interfaces.RecordPermissionListener;
...
public class MyMP3Record {
    ...
    private RecordPermissionListener mListener;
     ...
     */
    public MyMP3Record(File recordFile, RecordPermissionListener listener) {
